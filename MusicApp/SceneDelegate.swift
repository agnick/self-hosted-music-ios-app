...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    var window: UIWindow?
    private var audioImportInteractor: AudioImportInteractor?
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        self.audioImportInteractor = interactor
        
        Task {
            await audioImportInteractor?.checkAuthorizationForAllServices()
        }
